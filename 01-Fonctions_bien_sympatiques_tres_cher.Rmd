...
+ chaine de characteres -> objet : **get("var")**  
...
+ fonction pour aller chercher le fichier : **nomObjt <- file.choose()**  
...
+ Detect special charcters (logical) :  
x <- "!"  
...
## La syntaxe qui fait ch**r, du balai !
...
+ Ne garder les lignes que sans NA dans n'importe quelle colonne : **df[!complete.cases(df), ]**
...
+ convertir une chaine de charactère en date-time : **mdy_hms((Time))** mdy pour month, day, year, hms pour hour, minute, seconde. Modifier l'ordre des lettres selon votre format.
...
+ filter par date et heures : **filter(Date >= as.Date("2023-03-30") & Hour >= chron(times="18:00:00"))**
