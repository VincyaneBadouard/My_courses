...
= page d'aide du package (=1er bloc) (visible avec *package?Maria*)
...
installer le package à partir de sa source :
...
Cette methode le permet aussi, mais plus triviale : https://www.r-bloggers.com/2020/05/how-to-add-a-vignette-to-a-package-in-rstudio/
...
réf biblio (sauf celles des .rmd (vignette, site) gérées automatiquement avec *Rdpack* et *roxygen2*

De notre zotero/mendeley vers :
REFERENCES.bib dans le dossier "inst"
